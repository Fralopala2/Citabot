...
def get_servicios(store_id: str):
    instance_code = "0"
    group_data = get_group_startup(instance_code, store_id)
    servicios = []
...
def get_estaciones():
    ...
    instance_code = "0"
    group_data = get_group_startup(instance_code)
    estaciones = extract_stations(group_data)
...
def get_fechas(store: str, service: str, instance_code: str = "0", n: int = 3):
    ...
    fechas_horas = get_next_dates_with_hours(store, service, instance_code, n)
